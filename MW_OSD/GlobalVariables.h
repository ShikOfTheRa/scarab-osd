...
0, //   S_MWAMPERAGE,
0, // S_TX_CH_REVERSE
0, //   S_AMPERAGE_VIRTUALSPARE,   //spare
1, //   S_ALARMS_TEXT,
1, // S_CALLSIGN_ALWAYS
...
3, // S_VARIO_SCALE
0, // S_GPS_MASK
1, //   S_USEGPSHEADING, // fixedwing only
0, //   S_UNITSYSTEM,
0, //   S_VIDEOSIGNALTYPE,
...
(LINE07+14)|DISPLAY_ALWAYS|DISPLAY_DEV,   // horizonPosition
...
(LINE12+12)|DISPLAY_ALWAYS|DISPLAY_DEV,   // callSignPosition
