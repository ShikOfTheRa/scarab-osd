...
void displayIntro(void){
  ...
  line += LINE*2;
    ...
    //timezone
      ...
      if(abs(Settings[S_GPSTZ]) >= 100){
        ItoaPadded(Settings[S_GPSTZ], screenBuffer, 5, 4);}
      else{
        ItoaPadded(Settings[S_GPSTZ], screenBuffer, 4, 3);}
      if(Settings[S_GPSTZAHEAD] || Settings[S_GPSTZ] == 0){
        screenBuffer[0] = '+';}
      else{
        screenBuffer[0] = '-';}
