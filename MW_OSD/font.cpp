...
void FontClass::enterFontMode() {
  if(mwosd.armed || Msp.configMode || _inFontMode)
    return;
...
void FontClass::fontCharacterReceived(uint8_t cindex) {
  ...
  uint8_t bit = (0x80 >> (Msp.nextCharToRequest-cindex));
